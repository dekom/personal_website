<section class="twelve columns">
  <div class="alert-box alert">In Progress...</div>
</section>

<article class="twelve columns" id="main_body">

h1(#objective). Objective

h1(#summary). Summary

h1(#experience). Experience

h2(#nla). Neighborhood Learning Alliance
